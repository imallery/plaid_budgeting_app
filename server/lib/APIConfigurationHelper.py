...
class APIConfigurationHelper:
    ...
    def getPlaidCountryCodes():
        ...
        """
        return os.environ.get("PLAID_COUNTRY_CODES")
    
helper = APIConfigurationHelper()